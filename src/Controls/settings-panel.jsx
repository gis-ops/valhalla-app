...
class SettingsPanel extends React.Component {
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (!R.equals(profile, nextProps.profile)) {
            ...
            Object.keys(generalSettings).forEach(
                (v) => (generalSettings[v] = false)
            )

            const { extraSettings } = this.state
            Object.keys(extraSettings).forEach(
                (v) => (extraSettings[v] = false)
            )
    ...
    render() {
        ...
        const no_profile_settings =
            profile_settings[profile].boolean.length === 0
                    ...
                    >
                        <Grid columns={16} divided>
                            <Grid.Row>
                                ...
                                <Grid.Column
                                    width={no_profile_settings ? 16 : 8}
                                >
                                    <Form size={'small'}>
                                        <div
                                            className={
                                        ...
                                        <Divider />
                                        {settings_general[profile].boolean.map(
                                            (option, key) => {
                                                return (
                                                    <div
                                                        key={key}
                                        ...
                                        {settings_general.all.boolean.map(
                                            (option, key) => {
                                                return (
                                                    <div
                                                        key={key}
