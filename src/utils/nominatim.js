...
export const NOMINATIM_URL = `${import.meta.env.REACT_APP_NOMINATIM_URL}/search`
export const NOMINATIME_URL_REVERSE = `${import.meta.env.REACT_APP_NOMINATIM_URL}/reverse`
